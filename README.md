<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-0.5.17-4f8cff?style=for-the-badge&labelColor=1a1a2e" alt="Version" />
...
- **社区开源版，积木式扩展**：适合社区协作、自托管部署与二次开发，提供 MCP (Model Context Protocol) Server 和 CLI，支持二次开发和深度定制。
...
> 当前开源仓库的 `cjpm.toml` 已按云端依赖入口配置 Ignite 与 lisi。若你的环境使用本地镜像、私有源或离线依赖，请按实际构建环境改写依赖来源。
